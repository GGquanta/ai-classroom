---
title: VibeCoding — AI 协同开发经验指南
description: 归纳自多个 Cursor 项目实践，提炼 VibeCoding 的人机分工、文档先行、Plan→Implement 等可复制原则，以及六阶段推进路径与常见陷阱。
author: 朝阳
date: 2026-07-21
tags:
  - VibeCoding
  ...
  - workflow
category: workflows
cover: /assets/vibecoding-guide/vibecoding-human-ai-roles.png
---
...
![VibeCoding 人机分工示意：人负责目标、约束与验收，AI 负责检索、方案与实现](images/vibecoding-human-ai-roles.png)
...
![先收敛再动手：问答消歧 → 更新规格 → 用户确认 → 实现落地](images/vibecoding-plan-implement.png)
...
![可复制的六阶段推进路径：立项对齐 → 文档脚手架 → 模块交付 → 视觉精修 → 集成发版 → 知识回写](images/vibecoding-six-stage-path.png)
