---
title: 使用 AI 使图片转为三维模型
description: 以 4040 型材截面图为例，说明如何用 AI 编程工具识别轮廓、生成 DXF，再用 CadQuery 拉伸导出 STEP，并介绍多种输入资料、检查要点与适用边界。
author: 百万
date: 2026-09-02
tags:
  - cadquery
  ...
  - 工作流
category: workflows
cover: /assets/ai-image-to-3d-model/ai-cad-03-extrusion.png
coverTone: light
---

# 使用 AI 使图片转为三维模型

![从二维截面拉伸为三维铝型材](images/ai-cad-03-extrusion.png)
...
![从截面图片中识别实体边界和内部孔洞](images/ai-cad-01-profile-recognition.png)
...
![DXF闭合轮廓与局部闭合检查](images/ai-cad-02-dxf-profile.png)
...
![二维截面拉伸为三维铝型材](images/ai-cad-03-extrusion.png)
...
![在CAD软件中检查STEP模型和关键尺寸](images/ai-cad-04-cad-inspection.png)
