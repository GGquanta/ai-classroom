...
tags:
  ...
  - mcp
category: tools
cover: /assets/cc-switch-guide/cc-switch-main-ui.png
---
...
![CC Switch 主界面](images/cc-switch-main-ui.png)
...
![编辑供应商表单（图中是我配的 OpenRouter）](images/cc-switch-provider-form.png)
...
![配置用量查询](images/cc-switch-usage-dashboard.png)
