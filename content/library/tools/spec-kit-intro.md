---
title: Spec Kit 使用笔记
description: 介绍 Spec Kit：如何用 specify CLI 与 slash 命令做规格驱动开发，完成项目构建与代码编写。
author: wh
date: 2026-07-08
tags:
  - spec-kit
  ...
  - github
category: tools
cover: /assets/spec-kit-intro/spec-kit-video-header.jpg
---
...
用 Spec Kit 做过的内容都会保留记忆，以后的对话中会穿插那次的实际记录。

![SDD 制品关系](images/sdd-pipeline.png)
...
![目录结构](images/project-structure.png)
...
![specify init 过程](images/specify_cli.gif)
...
![命令分层](images/commands-overview.png)
...
![在代理里调用 slash 命令](images/bootstrap-claude-code.gif)
...
![精简 vs 生产路径](images/sdd-workflow-paths.png)
