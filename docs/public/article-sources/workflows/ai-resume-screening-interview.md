...
![AI 辅助招聘：人和助手一起整理简历材料](/assets/ai-resume-screening-interview/hero-ai-recruitment.png)

## 先把招聘材料分门别类放好

文件夹叫什么不重要，关键是把几类材料拆开，状态能追踪。我们大致分成四块：

![把职位说明、简历、面试材料分门别类放好](/assets/ai-resume-screening-interview/organize-folders.png)
...
![对照职位说明，逐份读简历并核对清单](/assets/ai-resume-screening-interview/resume-screening.png)
...
![面试现场：人负责听感，助手帮忙记内容](/assets/ai-resume-screening-interview/interview-scene.png)
...
![AI 起草建议，最终决断由面试官下笔](/assets/ai-resume-screening-interview/human-decides.png)
