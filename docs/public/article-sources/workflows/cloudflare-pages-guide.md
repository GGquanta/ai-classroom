...
![请求经边缘代理再到源站：浏览器 → 域名 → 边缘节点（CDN）→ 防护 → 源站](/assets/cloudflare-pages-guide/cloudflare-edge-proxy-path.png)
...
![仓库推送即上线：仓库 → 推送 → 构建 → 部署得到可访问链接](/assets/cloudflare-pages-guide/cloudflare-git-push-deploy.png)
