...
![VS Code 下载页面](/assets/ai-coding-tools-guide/vscode-download.png)

安装好之后即可以看到VS Code的主界面。

![VS Code 主界面](/assets/ai-coding-tools-guide/vscode-main-ui.png)
...
![搜索并安装 Cline 扩展](/assets/ai-coding-tools-guide/cline-extension-search.png)

安装好之后会自动打开Cline对话窗口（这里将对话框移动到了右侧）。

![Cline 对话窗口](/assets/ai-coding-tools-guide/cline-chat-panel.png)
...
![Cline API 配置](/assets/ai-coding-tools-guide/cline-api-config.png)
...
![保存配置后返回对话页面](/assets/ai-coding-tools-guide/cline-chat-ready.png)
...
![内容收集与调研任务示例](/assets/ai-coding-tools-guide/cline-research-task.png)
...
![MCP Server 配置](/assets/ai-coding-tools-guide/cline-mcp-config.png)

此时返回对话窗口，即可以允许Agent调用工具完成具体任务，如下所示：

![Agent 调用 MCP 工具完成任务](/assets/ai-coding-tools-guide/cline-mcp-fetch-result.png)
...
![向 AI 提出报告撰写需求](/assets/ai-coding-tools-guide/agents-md-task-request.png)
...
![AGENTS.md 提示词内容](/assets/ai-coding-tools-guide/agents-md-content.png)

编写好AGENTS.md后再完成相同的工作，我们可以看到AI输出的内容有了明显的不同。右侧（添加AGENTS.md后的输出内容）的文本更贴近于人类的表达习惯。

![添加 AGENTS.md 前后输出对比](/assets/ai-coding-tools-guide/agents-md-comparison.png)
...
![下达 HTML 页面开发任务](/assets/ai-coding-tools-guide/skill-html-task.png)

![HTML 页面开发任务进行中](/assets/ai-coding-tools-guide/skill-html-task-progress.png)

下面是得到的结果。

![未使用 Skill 时的页面效果](/assets/ai-coding-tools-guide/skill-html-result-before.png)
...
![SKILL.md 技能文件](/assets/ai-coding-tools-guide/skill-md-file.png)
...
![Agent 主动加载技能](/assets/ai-coding-tools-guide/skill-loaded.png)

然后观察输出成果，我们可以很容易地观察到Agent编写的页面质量有了显著的提高。

![使用 Skill 后的页面效果](/assets/ai-coding-tools-guide/skill-html-result-after.png)
...
![使用 find-skills 安装技能](/assets/ai-coding-tools-guide/skill-find-skills.png)
