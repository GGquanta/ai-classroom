...
![open-kimi-ppt 技术分享封面：结构化 PPTD、可视化编辑与 PPTX 导出](/assets/open-kimi-ppt-technical-sharing/cover.png)
...
![项目本地编辑器概览：打开 PPTD 项目、预览页面并进行编辑](/assets/open-kimi-ppt-technical-sharing/editor-overview.png)
...
![导出面板示例：支持 PPTX、图片、字体嵌入和切换动画选项](/assets/open-kimi-ppt-technical-sharing/export-pptx.png)
...
![示例项目在本地编辑器中打开：左侧显示 18 页缩略图，中央显示可编辑画布](/assets/open-kimi-ppt-technical-sharing/dji-editor.png)
...
![导出的产品 PPTX 示例：在 PowerPoint 中保留页面和可编辑对象](/assets/open-kimi-ppt-technical-sharing/dji-pptx.png)
...
![风格案例：项目不固定单一主题，可生成 Liquid Glass 等视觉方向](/assets/open-kimi-ppt-technical-sharing/liquid-glass.png)
...
![跨主题案例：小米 YU7 产品介绍 PPTX](/assets/open-kimi-ppt-technical-sharing/yu7-pptx.png)
