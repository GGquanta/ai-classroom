...
![SDD 制品关系](/assets/spec-kit-intro/sdd-pipeline.png)
...
![目录结构](/assets/spec-kit-intro/project-structure.png)
...
![specify init 过程](/assets/spec-kit-intro/specify_cli.gif)
...
![命令分层](/assets/spec-kit-intro/commands-overview.png)
...
![在代理里调用 slash 命令](/assets/spec-kit-intro/bootstrap-claude-code.gif)
...
![精简 vs 生产路径](/assets/spec-kit-intro/sdd-workflow-paths.png)
