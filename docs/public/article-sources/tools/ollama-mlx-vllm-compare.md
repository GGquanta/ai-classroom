...
![Mac 本地 AI 工作台（手绘插画）](/assets/ollama-mlx-vllm-compare/mac-local-ai-workbench.png)
...
![五种本地推理路线概览（手绘插画）](/assets/ollama-mlx-vllm-compare/local-inference-landscape.png)
...
![模型下载与镜像加速示意（手绘插画）](/assets/ollama-mlx-vllm-compare/local-model-download-mirror.png)
