...
![iCraft 3D 架构图与 Agent Skill：浅色扁平企业插画](/assets/icraft-3d-architecture/cover.png)
...
![官方网络架构模板：Internet、防火墙、交换机与终端分层展开](/assets/icraft-3d-architecture/01-official-network.png)
...
![混合云初稿：分区同色、网关与 Internet 同为地球仪、终端互连](/assets/icraft-3d-architecture/02-hybrid-first-draft.png)
...
![修订后导入编辑器：本地蓝、云区橙、分支绿，网关改为路由器](/assets/icraft-3d-architecture/03-hybrid-revised-editor.png)
