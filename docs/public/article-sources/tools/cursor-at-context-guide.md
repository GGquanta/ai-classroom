...
![三层上下文：自然语言、@ 引用与 Rules/Skills](/assets/cursor-at-context-guide/context-layers.png)
...
![各类 @ 引用速查](/assets/cursor-at-context-guide/at-types-overview.png)
...
![五种 @ 引用组合配方](/assets/cursor-at-context-guide/recipe-combinations.png)
