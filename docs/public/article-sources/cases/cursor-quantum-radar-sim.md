...
![项目整体架构示意](/assets/cursor-quantum-radar-sim/architecture-overview.png)
...
![状态机各阶段流转示意](/assets/cursor-quantum-radar-sim/stage-flow-diagram.png)
...
![前端 HMI 界面效果图](/assets/cursor-quantum-radar-sim/web-hmi-screenshot.png)
