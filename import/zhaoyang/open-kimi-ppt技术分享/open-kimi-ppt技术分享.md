...
![open-kimi-ppt 技术分享封面：结构化 PPTD、可视化编辑与 PPTX 导出](images/open-kimi-ppt/00-cover.png)
...
![项目本地编辑器概览：打开 PPTD 项目、预览页面并进行编辑](images/open-kimi-ppt/01-editor-overview.png)
...
![导出面板示例：支持 PPTX、图片、字体嵌入和切换动画选项](images/open-kimi-ppt/02-export-pptx.png)
...
![示例项目在本地编辑器中打开：左侧显示 18 页缩略图，中央显示可编辑画布](images/open-kimi-ppt/03-dji-editor.png)
...
![导出的产品 PPTX 示例：在 PowerPoint 中保留页面和可编辑对象](images/open-kimi-ppt/04-dji-pptx.png)
...
![风格案例：项目不固定单一主题，可生成 Liquid Glass 等视觉方向](images/open-kimi-ppt/05-liquid-glass.png)
...
![跨主题案例：小米 YU7 产品介绍 PPTX](images/open-kimi-ppt/06-yu7-pptx.png)
